...
5. **60-day rollover + annual-cap guardrail**
   - For indirect rollovers, start a deadline timer and show "days remaining" until rollover qualification expires.
   - Simulate annual contribution headroom impact before submission and block if projected over-limit.
   - Encode ABLE-to-ABLE frequency constraints separately from 529->ABLE rules.
