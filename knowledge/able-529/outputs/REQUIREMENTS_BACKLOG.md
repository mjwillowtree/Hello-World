...
5. **Source-plan signature guarantee rules service**
   - Track source-plan-specific requirement for signature guarantee/Medallion workflow.
   - If required, enforce completion of guarantee section before packet submission.
   - Store evidence URL and retrieval date for each rule.
