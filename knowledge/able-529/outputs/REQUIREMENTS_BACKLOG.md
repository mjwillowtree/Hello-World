...
5. **Plan-pair requirement rules engine**
   - Encode conditional source-plan requirements (e.g., Medallion Signature Guarantee required by source manager).
   - Surface requirement risk before form generation; route uncertain cases to manual verification.
   - Persist requirement evidence URL + retrieval date for audit replay.
