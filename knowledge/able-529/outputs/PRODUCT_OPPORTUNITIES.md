...
| 4 | **Rollover deadline + source-account closure guardrails** | Users satisfy one 60-day step but miss additional qualification conditions and create tax/benefit risk | ABLE United rollover terms require old-account closure discipline plus 12-month rollover constraints | 5 | 3 | Must track attested events without implying administrator-side legal advice | Medium-High |
...
- Newly validated: deadline controls must include both transfer timing and source-account closure/attestation checkpoints.
