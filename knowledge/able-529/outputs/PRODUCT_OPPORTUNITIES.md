...
| 4 | **Signature + limit orchestration guardrail** | Transfers fail late due to medallion/signature requirements or contribution-limit overflow | PA ABLE direct rollover form requires conditional medallion workflow and notes rejection above ABLE limits | 4 | 4 | Must avoid unauthorized legal/tax determination while enforcing operational constraints | High |
...
- Indiana now provides explicit state recapture trigger language including 529->ABLE rollover treatment.
- Signature-guarantee and contribution-limit rejection controls are confirmed as first-order workflow risks in PA ABLE operations.
