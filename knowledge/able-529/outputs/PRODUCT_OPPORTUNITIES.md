...
| 4 | **Plan-pair signature guarantee predictor** | Users discover medallion/signature requirements too late and stall | PA ABLE form shows source-manager-dependent medallion requirement; missing requirement can delay rollover | 4 | 4 | Must avoid false assurance; treat as conditional precheck with escalation | Medium-High |
...
- Source-plan-specific medallion/signature triggers emerged as an additional preventable delay vector.
- State-aware logic remains critical due unresolved NJ/PA line-level treatment and Indiana filing-year wording conflict.
