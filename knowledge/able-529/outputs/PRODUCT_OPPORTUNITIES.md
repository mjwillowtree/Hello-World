...
| 4 | **Federal-vs-State Divergence Interstitial** | Users and advisors incorrectly assume federal-qualified means state-safe | Indiana recapture workflow evidence despite federal rollover pathway | 5 | 4 | Must display confidence + jurisdiction-year caveats to avoid overreach | Medium-High |
...
- Indiana evidence confirms a concrete federal-vs-state divergence pattern that needs explicit UX treatment.
