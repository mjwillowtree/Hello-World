...
| 4 | **Contribution-cap reservation ledger** | Users can start a rollover that later breaches annual ABLE limit after other contributions post | ABLE Utah direct rollover form highlights annual-limit interaction; rollover counts against standard annual cap | 5 | 3 | Requires cross-channel contribution event ingestion and deterministic cap math | Medium-High |
...
- Cap-budget controls moved up: transfer success can fail even when legal eligibility is correct.
