...
| 5. Execute transfer | Submit forms/signatures and coordinate plans | Manual form burden; source-plan-specific signature guarantee requirements | Rejection/delay due to missing fields or missing Medallion Signature Guarantee where required | Packet builder + validation + source-plan requirement precheck |
...
5. Late discovery of source-plan medallion/signature-guarantee requirements.
