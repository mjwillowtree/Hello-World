...
| 4. Pre-transfer compliance | Validate docs, relationship, signature path, and cap checks | Missing source-plan earnings/principal docs; medallion requirement discovered too late | Submission blocked or misclassified | Hard-stop preflight validator + signature path detector |
| 5. Execute transfer | Submit forms/signatures and coordinate plans | Manual form burden; cross-plan limits and signature dependencies | Rejection due to missing fields/signatures or limit overflow | Packet builder + validation + projected-limit warning |
...
3. Signature guarantee/notarization requirement discovered after packet assembly.
...
- PA ABLE incoming direct rollover form: https://www.paable.gov/pdf/Incoming-Direct-Rollover.pdf
