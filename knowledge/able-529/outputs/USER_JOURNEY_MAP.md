...
| 5. Execute transfer | Submit forms/signatures and coordinate plans | Manual form burden; signature/notary requirements vary by source plan | Rejection due to missing fields/signatures/notary authority | Packet builder + role-aware validation |
...
3. Signature/notary requirement discovered too late in the workflow.
...
- STABLE direct rollover form: https://ableut.com/assets/docs/rollover-direct-csp-to-able-form.pdf
