...
| 4. Pre-transfer compliance | Validate docs and relationship/cap checks | Missing source-plan earnings/principal docs; no cap reservation before submission | Submission blocked, misclassified, or cap-overrun rejection | Hard-stop preflight validator + cap reservation ledger |
| 5. Execute transfer | Submit forms/signatures and coordinate plans | Manual form burden; conditional notarization/signature requirements | Rejection due to missing fields/signatures/notary | Packet builder + notarization-aware validation |
...
5. Annual-cap overflow causing full transfer rejection.
...
- ABLE Utah / STABLE direct rollover form: https://ableut.com/assets/docs/rollover-direct-csp-to-able-form.pdf
