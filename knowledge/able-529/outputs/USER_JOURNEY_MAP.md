...
| 3. Select funding path | Choose direct rollover, indirect rollover, or contribution | Poor understanding of path-specific requirements | Wrong path, 60-day timing errors, documentation gaps | Path explainer + required-doc preview + rollover timer guidance |
| 4. Pre-transfer compliance | Validate docs and relationship/cap checks | Missing source-plan earnings/principal docs; unclear annual-headroom impact | Submission blocked, misclassified, or over-limit | Hard-stop preflight validator + contribution headroom simulation |
...
3. 60-day indirect rollover deadline misses and contribution-cap overshoot.
...
- CalABLE indirect 529->ABLE rollover form: https://calable.ca.gov/assets/docs/rollover-indirect-csp-to-able-form.pdf
