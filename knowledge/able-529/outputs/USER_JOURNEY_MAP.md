...
| 5. Execute transfer | Submit forms/signatures and coordinate plans | Manual form burden; source-plan guarantee requirements discovered late | Rejection/delay due to missing Medallion Signature Guarantee or source-plan-specific formalities | Packet builder + source-plan requirement precheck |
...
1. Documentation gap before transfer submission (including missing principal/earnings certification).
2. Beneficiary/family-member mismatch.
3. Missing signature-guarantee requirement discovered after submission.
