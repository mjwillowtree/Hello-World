...
| 6. Track status | Understand progress and delays | Opaque multi-party handoff and missing outbound documentation | Repeat support calls, abandonment, post-funding reclassification risk | Timeline + reason codes + provider deadline timers |
| 7. Post/funding validation | Confirm posted amount and annual-cap interaction | Cross-contributor cap uncertainty and incomplete basis/earnings evidence | Over-limit contributions; transfer treated as earnings if documentation arrives late | Contribution headroom meter + evidence SLA monitor |
...
3. Opaque transfer status, delays, and unmet document deadlines.
...
- ABLEnow incoming 529 transfer form (60-day basis/earnings documentation requirement): https://www.ablenow.com/uploads/documents/ABLEnow_Incoming_Program-to-Program-Transfer_529.pdf
