...
| 4. Pre-transfer compliance | Validate docs and relationship/cap checks | Missing source-plan earnings/principal docs; rollover cooldown/closure rules not understood | Submission blocked, misclassified, or ineligible by program rules | Hard-stop preflight validator + cooldown eligibility gate |
| 5. Execute transfer | Submit forms/signatures and coordinate plans | Manual form burden; signature/notary requirements | Rejection due to missing fields/signatures or old-account closure failures | Packet builder + validation + closure attestation tracking |
...
5. Violating one-rollover-per-12-month and 60-day old-account closure constraints.
...
- STABLE ABLE rollover form: https://stableaccount.com/assets/docs/rollover-able-to-able-form.pdf
