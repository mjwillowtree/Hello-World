...
| 4. Pre-transfer compliance | Validate docs and relationship/cap checks | Missing source-plan earnings/principal docs | Submission blocked or transferred amount treated as earnings pending evidence | Hard-stop preflight validator |
| 5. Execute transfer | Submit forms/signatures and coordinate plans | Manual form burden; source-plan guarantee requirements | Rejection/delay due to missing signature guarantee or missing co-signer | Packet builder + validation |
...
3. Source-plan signature-guarantee dependency discovered too late.
