...
| 3. Select funding path | Choose direct rollover, indirect rollover, or contribution | Poor understanding of path-specific requirements | Wrong path, timing/document errors, federal-qualified/state-tax-unsafe assumptions | Path explainer + required-doc preview + divergence warning |
| 4. Pre-transfer compliance | Validate docs and relationship/cap checks | Missing source-plan earnings/principal docs; destination account not pre-created | Submission blocked or misclassified | Hard-stop preflight validator + destination-account readiness check |
...
5. Destination-account prerequisite missed before packet submission.
...
- STABLE direct rollover form: https://stableaccount.com/uploads/stable/attachments/cll2f89o5ystx0imdch37f43i-stable-rollover-direct-csp-to-able-1-3-ada.pdf
