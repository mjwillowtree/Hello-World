...
| 4. Pre-transfer compliance | Validate docs and relationship/cap checks | Missing source-plan earnings/principal docs; stale headroom estimate | Submission blocked, misclassified, or later over-limit | Hard-stop preflight validator + cap reservation |
...
| 7. Post/funding validation | Confirm posted amount and annual-cap interaction | Cross-contributor cap uncertainty | Over-limit contributions or forced reversals | Contribution headroom meter + exception workflow |
...
5. Headroom drift while rollover is in flight.
...
- ABLE Utah direct rollover form: https://ableut.com/assets/docs/rollover-direct-csp-to-able-form.pdf
