...
|---|---|---|---|---|
| 1. Discover eligibility | Confirm ABLE eligibility and who can act/fund | Confusion on onset age, ownership, and relationship rules | Ineligible progression, wrong actor setup | Eligibility gate + citation links |
...
| 5. Execute transfer | Submit forms/signatures and coordinate plans | Manual form burden; source-plan-specific signature guarantee requirements | Rejection due to missing fields/signatures or missing Medallion section where required | Packet builder + plan-specific signature validation |
...
| 8. Ongoing management + tax support | Contributions, distributions, records, filing | State-specific recapture uncertainty and nonqualified reporting complexity | Filing errors, audit readiness gaps | Filing helper + evidence vault |

## Highest-risk drop-off points

1. Documentation gap before transfer submission.
2. Beneficiary/family-member mismatch.
3. Late discovery of signature-guarantee requirement by source plan.
4. Opaque transfer status and delays.
5. State-specific recapture/nonqualified-reporting surprise at filing time.
...
- PA ABLE direct rollover form: https://www.paable.gov/pdf/Incoming-Direct-Rollover.pdf
- PA nonqualified reporting line mapping: https://revenue-pa.custhelp.com/app/answers/detail/a_id/2517/~/where-should-a-distribution-from-an-irc-section-529-college-and-career-saving
