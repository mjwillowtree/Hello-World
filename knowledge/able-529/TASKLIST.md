...
2. **State recapture matrix buildout (Phase 1: 12 states)**
   - Current status: 12 states touched (OR, CO, VA, NY, CA, NJ, PA, IL, OH, MN, UT, plus income-tax-state controls) with uneven confidence.
   - Expand into structured matrix with citations, conformity year, and form line references.
   - Immediate priority states: IN, PA.
   - Immediate confidence repairs: PA and UT ABLE-specific treatment precision.
