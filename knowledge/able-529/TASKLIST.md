...
2. **State recapture matrix buildout (Phase 1: 12 states)**
   - Current status: 12 states touched (OR, CO, VA, NY, CA, NJ, PA, IL, OH, MN, IN, UT) with uneven confidence.
   - Expand into structured matrix with citations, conformity year, and form line references.
   - Immediate priority states: NJ, PA.
   - Immediate confidence repairs: NJ and PA line-level treatment; exact Indiana Schedule 4 line reference.
...
- Closed Indiana destination-sensitive treatment using official DOR guidance and Schedule IN-529 filing-line mapping.
- Added Utah TC-40A code/line-level addback mapping from official instructions.
