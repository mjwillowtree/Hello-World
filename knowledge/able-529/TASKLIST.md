...
2. **State recapture matrix buildout (Phase 1: 12 states)**
   - Current status: 12 states touched with substantive evidence (OR, CO, VA, NY, CA, NJ, PA, IL, OH, MN, UT, IN).
   ...
   - New adversarial follow-up: Indiana in-state ABLE carveout confirmation (if any).
