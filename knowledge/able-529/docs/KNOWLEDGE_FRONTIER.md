...
| Federal 529->ABLE rollover legality and limits | 4 | 4 | Med-High | Statute + current Pub. 970 ch.10 now aligned; remaining risk is lag across lower-authority IRS newsroom/secondary surfaces. |
...
| State tax conformity + recapture/add-back (50-state) | 3 | 2 | High | Matrix now has 12 substantive rows; NJ/PA line-level closure remains highest priority. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | PA ABLE adds explicit source-plan signature-guarantee and basis-statement dependency evidence; still need SLA timing distributions. |
...
2. Validate IN/UT treatment continuity across TY2025/TY2026 forms.
