...
| State tax conformity + recapture/add-back (50-state) | 3 | 2 | High | Matrix scaffold spans 51 jurisdictions with 11 substantive rows after Utah closure; NJ/PA line-level closure remains highest priority, then Indiana expansion. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | Official forms from Fidelity, ABLE for ALL, Texas ABLE, and ABLE United confirm documentation/signer/deadline failure modes; still need quantified SLA timing evidence. |
...
2. Advance Indiana with IN-529 + recapture form-line authority.
