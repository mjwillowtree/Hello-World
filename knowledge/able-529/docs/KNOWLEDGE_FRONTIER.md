...
| State tax conformity + recapture/add-back (50-state) | 3 | 2 | High | Matrix now has 11 substantive rows including Indiana destination-sensitive treatment; NJ/PA line-level closure remains highest priority, then UT expansion. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | STABLE direct rollover form adds notary + full rejection on annual-limit overflow; still need quantified SLA timing evidence. |
