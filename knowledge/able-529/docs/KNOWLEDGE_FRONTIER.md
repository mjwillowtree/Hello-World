...
Updated: 2026-03-10 (run 22:00 UTC)
...
| State tax conformity + recapture/add-back (50-state) | 3 | 2 | High | Matrix scaffold spans 51 jurisdictions with 11 substantive rows (UT added); NJ/PA line-level closure remains highest priority, then IN expansion. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | Official forms now include CalABLE timing/cap constraints in addition to Fidelity/ABLE for ALL/Texas ABLE; still need transfer SLA distribution evidence. |
...
6. "IRS lag is uniform across all IRS materials." (false: publication and newsroom update at different speeds)
