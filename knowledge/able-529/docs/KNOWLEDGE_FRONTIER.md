...
Updated: 2026-03-11 (run 06:00 UTC)
...
| State tax conformity + recapture/add-back (50-state) | 3 | 3 | High | Indiana destination-specific recapture logic now closed with form-line mapping; NJ/PA line-level closure remains highest priority, then UT expansion. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | Official forms from Fidelity, ABLE for ALL, ABLEnow, Texas ABLE, and PA ABLE confirm documentation/signer/guarantee failure modes; still need SLA timing evidence. |
...
2. Add Utah with line-level state treatment evidence.
