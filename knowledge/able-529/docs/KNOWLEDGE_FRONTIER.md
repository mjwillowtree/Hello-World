...
| State tax conformity + recapture/add-back (50-state) | 3 | 2 | High | Matrix scaffold spans 51 jurisdictions with 11 substantive rows (Utah advanced); NJ/PA line-level closure remains highest priority, then IN expansion. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | Official forms from Fidelity, ABLE for ALL, Texas ABLE, and ABLE Utah confirm documentation/signer/cap-budget failure modes; still need SLA timing evidence. |
...
2. Advance Indiana to first-pass Tier-1 form-line row.
