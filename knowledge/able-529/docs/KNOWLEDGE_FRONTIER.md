...
| Program-level operational constraints (plan forms, timing) | 2 | 3 | Med | Official forms now include Fidelity, ABLE for ALL, Texas ABLE, ABLEnow, and STABLE; still need SLA timing evidence. |
...
2. Advance Utah to first substantive Tier-1 matrix row.
...
6. "Credit states will treat 529->ABLE similarly to deduction states." (Indiana evidence suggests this can fail)
