...
Scoring:
- **Coverage (0-5):** how much of topic landscape is mapped.
- **Confidence (0-5):** legal/operational confidence in current understanding.
- **Volatility (Low/Med/High):** likelihood guidance changes or differs by jurisdiction.
...
| State tax conformity + recapture/add-back (50-state) | 3 | 3 | High | Matrix scaffold spans 51 jurisdictions with 12 substantive rows; PA line-level closure and IN expansion are highest priorities. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | Official forms from Fidelity, ABLE for ALL, Texas ABLE, and STABLE confirm documentation/signer and cooldown/closure failure modes; still need SLA timing evidence. |
...
1. Close PA to line-level high-confidence treatment.
2. Advance Indiana to first-pass code/line-level state row.
3. Expand operations lane from form constraints to timing/SLA evidence and exception-frequency measurement.
...
6. "If rollover rules are legally valid, transfer operations are friction-light." (often false due cooldown/closure/document requirements)
