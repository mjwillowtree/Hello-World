...
| State tax conformity + recapture/add-back (50-state) | 3 | 3 | High | Matrix scaffold spans 51 jurisdictions with 11 substantive rows; NJ/PA line-level closure remains highest priority, with UT next and Indiana quote-hardening pending. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | Official forms from Fidelity, ABLE for ALL, Texas ABLE, and STABLE confirm documentation/signer/notarization/destination-account failure modes; still need SLA timing evidence. |
...
3. Quantify transfer timing/SLA distributions and rejection frequencies across at least two programs.
...
6. "If rollover is federally qualified, state tax-credit recapture is automatically avoided." (invalidated by Indiana evidence)
