...
| Federal 529->ABLE rollover legality and limits | 4 | 4 | Med | Sunset issue resolved via Pub. L. 119-21 / §529 amendment and reinforced by IRS Pub. 970 (2025); still need compact quote appendix across all user-facing channels. |
...
| State tax conformity + recapture/add-back (50-state) | 3 | 2 | High | Matrix scaffold spans 51 jurisdictions with 11 substantive rows; NJ/PA line-level closure remains highest priority, then UT expansion. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | Official forms from Fidelity, ABLE for ALL, Texas ABLE, and STABLE confirm documentation/signer/notary failure modes; still need SLA timing evidence. |
...
2. Advance Utah to first line-level Tier-1 state row.
