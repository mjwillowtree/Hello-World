...
| Federal 529->ABLE rollover legality and limits | 4 | 5 | Med | Sunset issue materially resolved via Pub. L. 119-21 / §529 amendment; Pub 970/907 check now appears conformed, but legacy newsroom cleanup risk remains. |
...
| State tax conformity + recapture/add-back (50-state) | 3 | 3 | High | Matrix scaffold spans 51 jurisdictions with 11 substantive rows; NJ/PA line-level closure remains highest priority, then UT expansion. |
| Program-level operational constraints (plan forms, timing) | 3 | 3 | Med | Official forms now include Fidelity, ABLE for ALL, Texas ABLE, ABLEnow, and PA ABLE; still need SLA timing evidence. |
...
2. Advance Utah with direct line/code evidence from accessible Tier-1 sources.
...
4. "IRS lag is uniform across all IRS primary materials." (false; publications and newsroom can diverge)
